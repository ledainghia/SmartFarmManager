        ...
        public IActionResult DataFullSeedDemo()
        {
            try
            {
                ...
                var users = new List<User>
                {
                    ...
                    new User { Id = Guid.Parse("8dac47e4-58b6-43ef-aac8-c9c4315bd4e0"), Username = "staff_farm_3", PasswordHash = "5994471abb01112afcc18159f6cc74b4f511b99806da59b3caf5a9c173cacfc5", FullName = "Farm Staff", Email = "staff@farm.com", PhoneNumber = "0987654321", Address = "Staff Address", IsActive = true, CreatedAt = DateTime.UtcNow, RoleId = Guid.Parse("70702de9-89bc-48e5-861e-f4c1a5ac01d8") }, // Staff
