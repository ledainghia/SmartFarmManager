...
CREATE TABLE [GrowthStages] (
    ...
    CONSTRAINT [FK__GrowthSta__FarmI__1BC821DD] FOREIGN KEY ([FarmId]) REFERENCES [Farms] ([Id]),
...
CREATE INDEX [IX_GrowthStages_FarmId] ON [GrowthStages] ([FarmId]);
GO
...
VALUES (N'20241126050349_init', N'8.0.10');
GO
...
ALTER TABLE [GrowthStages] DROP CONSTRAINT [FK__GrowthSta__FarmI__1BC821DD];
GO

DROP INDEX [IX_GrowthStages_FarmId] ON [GrowthStages];
GO
...
WHERE ([d].[parent_object_id] = OBJECT_ID(N'[GrowthStages]') AND [c].[name] = N'FarmId');
IF @var0 IS NOT NULL EXEC(N'ALTER TABLE [GrowthStages] DROP CONSTRAINT [' + @var0 + '];');
ALTER TABLE [GrowthStages] DROP COLUMN [FarmId];
GO

ALTER TABLE [Cages] ADD [FarmId] uniqueidentifier NULL DEFAULT '00000000-0000-0000-0000-000000000000';
GO

CREATE INDEX [IX_Cages_FarmId] ON [Cages] ([FarmId]);
GO

ALTER TABLE [Cages] ADD CONSTRAINT [FK__Farm__CageI__2321213213] FOREIGN KEY ([FarmId]) REFERENCES [Farms] ([Id]);
GO

INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20241205044735_updateFarmAndGrowthStage', N'8.0.10');
GO
